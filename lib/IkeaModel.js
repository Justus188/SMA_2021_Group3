...
const probArrival = 0.5;//03371734; // mean interarrival measured to be 29.15
//We assume arrivals to follow Poisson Process, which is memoryless
//pexp(1, 29.15) = prob Arrival per s
const serviceTime = 500; // Placeholder serviceTime for testing

// To generate number of pax
function getPax(){
	const randint = Math.random()
	const found = paxcdf.find(element => element > randint)
	return found}
