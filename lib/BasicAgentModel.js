...
const probArrival = 0.03371734; // mean interarrival measured to be 29.15, pexp(1, 29.15) = prob Arrival per s
const serviceTime = 2704; // mean servicetime measured to be 2704s
...
function updateCustomer(customerId){
	...
	switch(state){
		...
		case SHOPPING: //Rae
			...
			if (STAGING_SPOT[0]==0 && empty_table !== undefined){
				...
				stats[0].count++;
			} else if (empty_staging_spot !== undefined) {
